...
@register
class PathDetails(Ressource):
    _api_version = "v1"
    _name = "path_details"
    _primary_keys = ("id_path_details", "id_malette")

    class _rel:
        start_node = Relationship(RessourceProxy("path_node"))
        stop_node = Relationship(RessourceProxy("path_node"))
